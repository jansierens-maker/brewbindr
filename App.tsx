        ...
        <div className="print:hidden">
          ...
          <main className="max-w-7xl mx-auto px-4 py-10 pb-32">
            ...
            {view === 'log' && selectedRecipe && (
              <BrewLog recipe={selectedRecipe} initialLog={selectedBrewLog || undefined} onUpdate={handleUpdateBrewLog} onSaveAndExit={handleSaveAndExitBrewLog} library={library} onGoToLibrary={() => setView('library')} />
            )}
            {view === 'create' && (
              <RecipeCreator
